...
def startGame():
    ...
    turtle.clearscreen()
    turtle.hideturtle()
    colors = ["red", "green", "blue", 'yellow', 'pink', 'orange', 'purple', 'black', 'grey','brown',"red", "green", "blue", 'yellow', 'pink', 'orange', 'purple', 'black', 'grey','brown',"red", "green", "blue", 'yellow', 'pink', 'orange', 'purple', 'black', 'grey','brown',"red", "green", "blue", 'yellow', 'pink', 'orange', 'purple', 'black', 'grey','brown',"red", "green", "blue", 'yellow', 'pink', 'orange', 'purple', 'black', 'grey','brown']
